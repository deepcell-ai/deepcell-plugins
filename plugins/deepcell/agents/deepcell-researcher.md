...
- Evidence cites something outside the model. A body reading "assumed" or
  "estimated" is an assumption in evidence's clothes; record it as the
  assumption it is.
- The figure you cite a source for is the figure the source states. If you
  adjusted it, the adjustment is a calculation or an assumption of its own,
  recorded.
